...
const LESSON_07 = {
  ...
  hintEn: "'Ça vous dit de...' is the most natural way to invite someone!",
  hintFr: "'Ça vous dit de...' est la façon la plus naturelle d'inviter quelqu'un !",
  vocabulary: [],
  contentHtml: `
...
<tr><td class=\"\">À quelle heure ?<\/td><td>At what time?<\/td><\/tr>
</tr><td class=\"\">Je suis libre samedi.<\/td><td>I'm free on Saturday.<\/td><\/tr>
<tr><td class=\"\">Avec plaisir !<\/td><td>With pleasure!<\/td><\/tr>
</tbody>
<\/table>
<\/div>
<div class=\"lesson-rule\">
...
<tbody>
<tr><td class=\"\">au restaurant<\/td><td>to a restaurant<\/td><\/tr>
<tr><td class=\"\">au café<\/td><td>to a café<\/td><\/tr>
<tr><td class=\"\">en balade<\/td><td>for a walk / drive<\/td><\/tr>
<tr><td class=\"\">au cinéma<\/td><td>to the cinema<\/td><\/tr>
</tbody>
<\/table>
<\/div>
<div class=\"lesson-example\">
<strong>Exemple :<\/strong> Ça vous dit d'aller au restaurant samedi soir ?
  ...
  qcm: [
    {
      ...
      questionFr: "Traduisez : 'Ça vous dit d'aller au restaurant ?'",
    ...
    },
    {
      ...
      questionFr: "Traduisez : 'Je suis libre samedi.'",
    ...
    },
    {
      ...
      questionFr: "Traduisez : 'On se retrouve où ?'",
      options: ["On se retrouve où ?", "Où on va ?", "On se voit comment ?", "Où se rencontrer ?"],
      optionsEn: ["Where shall we meet?", "Where do we go?", "How do we see each other?", "Where to meet?"],
    ...
    },
    {
      ...
      optionsEn: ["With pleasure!", "Yes of course!", "Why not!", "Okay!"],
    ...
    },
    {
      ...
      questionFr: "Traduisez : 'Je suis désolé(e), je ne peux pas vendredi.'",
      options: ["Je suis désolé(e), je ne peux pas vendredi.", "Je peux pas vendredi.", "Vendredi non.", "Désolé vendredi."],
      optionsEn: ["I'm sorry, I can't on Friday.", "I can't on Friday.", "Friday no.", "Sorry Friday."],
    ...
    },
    {
      ...
      questionFr: "Comment dit-on 'À quelle heure ?'",
      options: ["À quelle heure ?", "Quelle heure est ?", "Quand heure ?", "C'est l'heure ?"],
      optionsEn: ["At what time?", "What time is it?", "When hour?", "Is it time?"],
    ...
    },
    {
      ...
      questionFr: "Traduisez : 'On va se promener.'",
      options: ["On va se promener.", "On fait promenade.", "Allons promenade.", "On marche."],
      optionsEn: ["Let's go for a walk.", "We do a walk.", "Let's go walk.", "We walk."],
    ...
    },
    {
      ...
      questionFr: "Traduisez : 'Peut-être la prochaine fois.'",
    ...
    },
    {
      ...
      optionsEn: ["Good idea!", "Good idea (masculine wrong)", "It's idea!", "Idea good!"],
      correct: "Bonne idée !",
      correctEn: "Good idea!",
  ...
  libre: [
    {
      ...
      questionFr: "Invitez votre voisin pour un café.",
