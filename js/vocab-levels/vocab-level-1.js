...
const VOCAB_LEVEL_1 = [
  ...
  {fr:"nationalité",en:"nationality",phondef:"Au revoir pour le lendemain",ex:"À demain, bonne soirée.",level:1,cat:"salutation"},
  {fr:"à tout à l'heure",en:"see you later",phon:"*a too-ta LUR*",def:"Au revoir pour dans quelques heures",ex:"À tout à l'heure, je reviens.",level:1,cat:"salutation"},
  {fr:"bonne nuit",en:"good night",phon:"*bon NWEE*",def:"Souhait avant de dormir",ex:"Bonne nuit, fais de beaux rêves.",level:1,cat:"salutation"},
  {fr:"bonne journée",en:"have a good day",phon:"*bon zhoor-NAY*",def:"Souhait pour la journée",ex:"Bonne journée, monsieur.",level:1,cat:"salutation"},
  {fr:"bon week-end",en:"have a good weekend",phon:"*bon WEEK-end*",def:"Souhait pour le week-end",ex:"Bon week-end à tous !",level:1,cat:"salutation"},
  ...
  {def:"Au revoir pour le lendemain",ex:"À demain, bonne soirée.",level:1,cat:"salutation"},
  {fr:"à tout à l'heure",en:"see you later",phon:"*a too-ta LUR*",def:"Au revoir pour dans quelques heures",ex:"À tout à l'heure, je reviens.",level:1,cat:"salutation"},
  {fr:"bonne nuit",en:"good night",phon:"*bon NWEE*",def:"Souhait avant de dormir",ex:"Bonne nuit, fais de beaux rêves.",level:1,cat:"salutation"},
  {fr:"bonne journée",en:"have a good day",phon:"*bon zhoor-NAY*",def:"Souhait pour la journée",ex:"Bonne journée, monsieur.",level:1,cat:"salutation"},
  {fr:"bon week-end",en:"have a good weekend",phon:"*bon WEEK-end*",def:"Souhait pour le week-end",ex:"Bon week-end à tous !",level:1,cat:"salutation"},
  ...
  {fr:"excuse-moi",en:"excuse me (informal)",phon:"*ek-skew-MWA*",def:"Demande d'excuse familière",ex:"Excuse-moi, je suis en retard.",level:1,cat:"politesse"},
  ...
  {fr:"je vous remercie",en:"I thank you",phon:"*zhuh voo ruh-mair-SEE*",def:"Remerciement formel",ex:"Je vous remercie beaucoup.",level:1,cat:"politesse"},

  // === TITRES (4) ===
  {fr:"monsieur",en:"sir / mister",phon:"*mudef:"Au revoir pour le lendemain",ex:"À demain, bonne soirée.",level:1,cat:"salutation"},
  {fr:"à tout à l'heure",en:"see you later",phon:"*a too-ta LUR*",def:"Au revoir pour dans quelques heures",ex:"À tout à l'heure, je reviens.",level:1,cat:"salutation"},
  {fr:"bonne nuit",en:"good night",phon:"*bon NWEE*",def:"Souhait avant de dormir",ex:"Bonne nuit, fais de beaux rêves.",level:1,cat:"salutation"},
  {fr:"bonne journée",en:"have a good day",phon:"*bon zhoor-NAY*",def:"Souhait pour la journée",ex:"Bonne journée, monsieur.",level:1,cat:"salutation"},
  {fr:"bon week-end",en:"have a good weekend",phon:"*bon WEEK-end*",def:"Souhait pour le week-end",ex:"Bon week-end à tous !",level:1,cat:"salutation"},
  ...
  {fr:"messieurs-dames",en:"ladies and gentlemen",phon:"*mes-SYUR DAM*",def:"Formule d'adresse collective",ex:"Bonjour messieurs-dames.",level:1,cat:"politesse"},
