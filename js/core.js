...
//
// CORRECTIONS v2.2 :
//   + DIRECTION_MODES ajouté AVANT DirectionMode
//   + flipQuestion() extrait en fonction globale
//   + DirectionMode.load() et set() protégés contre gameState undefined
// ═══════════════════════════════════════════════════════════════════
...
const I18N = {
  en: {
    ...
    dirEnFirst: '🇬🇧→🇫🇷 English: 'dailyFrench_players',
  theme: 'dailyFrench_theme',
  lang: 'dailyFrench_lang',
  direction: 'dailyFrench_direction',
  genius: 'dailyFrench_genius',
...
// ═══════════════════════════════════════════════════════════════════
// 4. DIRECTION MODES — NOUVEAU v2.2
// ═══════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════
// 6. FLIP QUESTION — NOUVEAU v2.2 (fonction globale)
// ═══════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════
// 16. SETTINGS — Thème, langue, DIRECTION
// ═══════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════
// 17. BRIDGE API — Compatibilité anciens appels
// ═══════════════════════════════════════════════════════════════════
...
function goToVocabulary(): 'dailyFrench_players',
  theme: 'dailyFrench_theme',
  lang: 'dailyFrench_lang',
  direction: 'dailyFrench_direction',
  genius: 'dailyFrench_genius',
