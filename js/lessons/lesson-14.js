// lesson-14.js — My Needs 🍽️ — avoir + noun
const LESSON_14 = {
  id: 14,
  title: "My Needs 🍽️ — avoir + noun",
  titleFr: "Mes besoins — avoir + nom",
  objectiveEn: "Express hunger, thirst, tiredness and desires using avoir",
  objectiveFr: "Exprimer la faim, la soif, la fatigue et les désirs avec avoir",
...
<div class="lesson-warning">⚠️ <strong>Je veux</strong> = I want (direct). <strong>Je voudrais</strong> = I would like (polite). Always use voudrais in shops and restaurants!</div>
  ...
  qcm: [
    {
      ...
      explanationFr: "J'ai faim = j'ai faim. Littéralement 'j'ai la faim'. Toujours avec avoir !"
    },
    {
      id: "14-2",
      type: "qcm",
    ...
    },
    {
      ...
      explanationFr: "J'ai sommeil = j'ai sommeil. Littéralement 'j'ai la somnolence'."
    },
    {
      id: "14-4",
      type: "qcm",
    ...
    },
    {
      ...
      questionFr: "La façon POLIE de dire 'Je veux un café' :",
