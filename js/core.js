...
const I18N = {
  en: {
    ...
    hint: 'Hint', vocabulary: 'Vocabulary',_v1',
  analytics: 'dailyFrench_analytics_opt_out'
};
...
const Theme = {
  apply(name) {
    ...
    Storage.set(KEYS.theme, name_v1',
  analytics: 'dailyFrench_analytics_opt_out'
};
...
function applyDirectionPick(mode) {
  ...
  // Mettre à jour les boutons actifs s'ils existent
...
function initCore() {
  ...
  const inpModal = document.getElementBy_v1',
  analytics: 'dailyFrench_analytics_opt_out'
};
