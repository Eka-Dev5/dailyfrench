...
<tbody>
<tr><td class=\"\">mon mari / ma femme<\/td><td>my husband / my wife<\/td><\/tr>
<tr><td class=\"\">mon fils / ma fille<\/td><td>my son / my daughter<\/td><\/tr>
<tr><td class=\"\">mes enfants<\/td><td>my children<\/td><\/tr>
<tr><td class=\"\">mon frère / ma sœur<\/td><td>my brother / my sister<\/td><\/tr>
<tr><td class=\"\">mon père / ma mère<\/td><td>my father / my mother<\/td><\/tr>
<tr><td class=\"\">mes petits-enfants<\/td><td>my grandchildren<\/td><\/tr>
</tbody>
<\/table>
<\/div>
<div class="lesson-rule">
...
<tbody>
<tr><td class=\"\">mon (mari, fils)<\/td><td>ma (femme, fille)<\/td><td>mes (enfants)<\/td><\/tr>
</tbody>
<\/table>
<\/div>
...
Mon mari et mes enfants vivent en Angleterre.
...
<span class="lesson-ex-en">My husband and my children live in England.</span>
  ...
  qcm: [
    {
      ...
      optionsEn: ["My husband", "My husband (wrong gender)", "My man", "The husband mine"],
      correct: "Mon mari",
    ...
    },
    {
      ...
      questionFr: "Comment dit-on 'ma femme' ?",
      options: ["Ma femme", "Mon femme", "Ma wife", "La femme moi"],
      optionsEn: ["My wife", "My wife (wrong gender)", "My wife (English)", "The wife me"],
      correct: "Ma femme",
      correctEn: "My wife",
    ...
    },
    {
      ...
      questionFr: "Comment dit-on 'mon fils' ?",
      options: ["Mon fils", "Ma fils", "Mon fiston", "Le fils mien"],
      optionsEn: ["My son", "My son (wrong)", "My son (diminutive)", "The son mine"],
      correct: "Mon fils",
      correctEn: "My son",
    ...
    },
    {
      ...
      questionFr: "Comment dit-on 'ma fille' ?",
      options: ["Ma fille", "Mon fille", "Ma girl", "La fille mien"],
      optionsEn: ["My daughter", "My daughter (wrong)", "My girl (English)", "The daughter mine"],
      correct: "Ma fille",
    ...
    },
    {
      ...
      optionsEn: ["My grandchildren", "My grandchild", "My (fem) grandchildren", "The grandchildren mine"],
    ...
    },
    {
      ...
      questionFr: "Comment dit-on 'mon frère' ?",
      options: ["Mon frère", "Ma frère", "Mon brother", "Le frère mien"],
      optionsEn: ["My brother", "My brother (wrong gender)", "My brother (English)", "The brother mine"],
      correct: "Mon frère",
    ...
    },
    {
      ...
      questionFr: "'Mon amie' (pour une amie) — pourquoi pas 'ma amie' ?",
    ...
    },
    {
      ...
      questionFr: "Comment dit-on 'mes parents' ?",
      options: ["Mes parents", "Mon parent", "Ma parents", "Les parents miens"],
      optionsEn: ["My parents", "My parent", "My (fem) parents", "The parents mine"],
      correct: "Mes parents",
    ...
    },
    {
      ...
      questionFr: "Traduisez : 'Nous avons trois petits-enfants.'",
      ...
      optionsEn: ["We have three grandchildren.", "We are three grandchildren.", "We have three grandchildren (informal)", "Our grandchildren are three."],
  ...
  libre: [
    ...
    },
    {
      id: "16-l10",
      type: "libre",
      question: "Complete: 'J'ai ___ enfants.' (2,3,4,5)",
