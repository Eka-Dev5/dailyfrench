...
function loadConversations() {
  ...
  function checkComplete() {
    ...
    if (pending === 0) {
      ...
      console.log("[Talk] Loaded: " + loaded + "/20 conversations (errors: " + errors + ")");
  ...
  for (let i = 1; i <= count; i++) {
    ...
    script.onload = function() {
      ...
      if (typeof window[convVar] !== "undefined") {
        ...
        errors++;
        console.error("[Talk] Missing variable: " + convVar);
      }
      checkComplete();
    };
    ...
    script.onerror = function() {
      errors++;
      console.error("[Talk] Failed to load: js/conversations/conversation-" + numStr + ".js");
      checkComplete();
    };
