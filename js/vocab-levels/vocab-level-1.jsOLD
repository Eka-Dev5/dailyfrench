...
const VOCAB_LEVEL_1 = [
  // === SALUTATIONS (15) ===
  {fr:"bonjour",en:"hello / good morning",phon:"*bon-ZHOOR*",def:"Salutation du matin/journée.",ex:"Bonjour, comment allez-vous ?",level:1,cat:"salutation"},
  ...
  {fr:"bonne soirée",en:"have a good evening",phon:"*bon swa-RAY*",def:"Souhait pour la soirée.",ex:"Bonne soirée à vous.",level:1,cat:"salutation"},
  {fr:"bonne année",en:"happy new year",phon:"*bon a-NAY*",def:"Vœux du nouvel an.",ex:"Bonne année et bonne santé !",level:1,cat:"salutation"},
  {fr:"joyeux anniversaire",en:"happy birthday",phon:"*zhwa-YUR a-nee-vair-SAIR*",def:"Vœux d'anniversaire.",ex:"Joyeux anniversaire !",level:1,cat:"salutation"},
  {fr:"bienvenue",en:"welcome",phon:"*byan-vuh-NEW*",def:"Accueil.",ex:"Bienvenue chez nous !",level:1,cat:"salutation"},
  ...
  {fr:"nom",en:"name",phon:"*NOM*",def:"Appellation.",ex:"Quel est votre nom ?",level:1,cat:"présentation"},
  ...
  {fr:"profession",en:"profession",phon:"*pro-fes-SYON*",def:"Activité professionnelle.",ex:"Quelle est votre profession ?",level:1,cat:"présentation"},
  ...
  {fr:"s'il te plaît",en:"please (informal)",phon:"*seel tuh PLEH*",def:"Formule de politesse familière.",ex:"Passe-moi le sel, s'il te plaît.",level:1,cat:"politesse"},
  ...
  {fr:"excusez-moi",en:"excuse me",phon:"*ek-skew-zay-MWAH*",def:"Demande d'excuse formelle.",ex:"Excusez-moi, l'heure s'il vous plaît ?",level:1,cat:"politesse"},
  {fr:"excuse-moi",en:"excuse me (informal)",phon:"*ek-skew-MWAH*",def:"Demande d'excuse familière.",ex:"Excuse-moi, je suis en retard.",level:1,cat:"politesse"},
  {fr:"avec plaisir",en:"with pleasure",phon:"*a-vek pleh-ZEER*",def:"Réponse positive polie.",ex:"Avec plaisir, je vous aide.",level:1,cat:"politesse"},
  {fr:"pas de problème",en:"no problem",phon:"*pa duh pro-BLEM*",def:"Tout va bien.",ex:"Pas de problème, je comprends.",level:1,cat:"politesse"},
  {fr:"je vous remercie",en:"I thank you",phon:"*zhuh voo ruh-mair-SEE*",def:"Remerciement formel.",ex:"Je vous remercie de votre temps.",level:1,cat:"politesse"},
  ...
  {fr:"messieurs-dames",en:"ladies and gentlemen",phon:"*may-SYUR DAM*",def:"Salutation collective.",ex:"Bonsoir messieurs-dames.",level:1,cat:"politesse"},

  // === SOCIAL (4) ===
  {fr:"ami",en:"friend (male)",phon:"*a-MEE*",def:"Compagnon, camarade.",ex:"C'est mon meilleur ami.",level:1,cat:"social"},
  {fr:"amie",en:"friend (female)",phon:"*a-MEE*",def:"Compagne, camarade.",ex:"C'est ma meilleure amie.",level:1,cat:"social"},
  {fr:"voisin",en:"neighbor (male)",phon:"*vwa-ZAN*",def:"Personne qui habite à côté.",ex:"Mon voisin est sympa.",level:1,cat:"social"},
  {fr:"voisine",en:"neighbor (female)",phon:"*vwa-ZEEN*",def:"Personne qui habite à côté.",ex:"Ma voisine m'aide souvent.",level:1,cat:"social"}
];
