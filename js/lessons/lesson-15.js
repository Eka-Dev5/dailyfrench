...
<tbody>
<tr><td class=\"\">faire le ménage<\/td><td><em>*fair le may-NAZH*<\/em><\/td><td>do the housework<\/td><\/tr>
<tr><td class=\"\">faire la vaisselle<\/td><td><em>*fair la vay-SELL*<\/em><\/td><td>do the dishes<\/td><\/tr>
<tr><td class=\"\">faire le lit<\/td><td><em>*fair le LEE*<\/em><\/td><td>make the bed<\/td><\/tr>
<tr><td class=\"\">passer l'aspirateur<\/td><td><em>*pass-ay las-peer-a-TUR*<\/em><\/td><td>vacuum<\/td><\/tr>
</td><td class=\"\">ranger<\/td><td><em>*ran-ZHAY*<\/em><\/td><td>tidy up<\/td><\/tr>
<tr><td class=\"\">nettoyer<\/td><td><em>*net-wa-YAY*<\/em><\/td><td>clean<\/td><\/tr>
<tr><td class=\"\">sortir les poubelles<\/td><td><em>*sor-TEER lay poo-BELL*<\/em><\/td><td>take out the bins<\/td><\/tr>
</tbody>
<\/table>
<\/div>
...
Le lundi, je fais le ménage et je passe l'aspirateur dans toute la maison.
...
<span class="lesson-ex-en">On Mondays, I do the housework and vacuum the whole house.</span>
  ...
  qcm: [
    ...
    },
    {
      ...
      questionFr: "Traduisez : 'Je fais la vaisselle.'",
    ...
    },
    {
      ...
      questionFr: "Traduisez : 'Je passe l'aspirateur.'",
      options: ["Je passe l'aspirateur.", "Je fais l'aspirateur.", "J'aspire.", "Je nettoie avec l'aspirateur."],
      optionsEn: ["I vacuum.", "I do the vacuum.", "I suck (aspire)", "I clean with the vacuum."],
      correct: "Je passe l'aspirateur.",
      correctEn: "I vacuum.",
      explanation: "Passer l'aspirateur (*pass-ay las-peer-a-TUR*) = to vacuum. Not faire — it's passer!",
    ...
    },
    {
      ...
      questionFr: "Traduisez : 'Je fais le lit.'",
    ...
    },
    {
      ...
      questionFr: "Traduisez : 'Je sors les poubelles.'",
      options: ["Je sors les poubelles.", "Je jette les poubelles.", "Je fais les poubelles.", "Je mets les poubelles."],
      optionsEn: ["I take out the bins.", "I throw away the bins.", "I do the bins.", "I put the bins."],
    ...
    },
    {
      ...
      questionFr: "Traduisez : 'Je fais la cuisine.'",
    ...
    },
    {
      ...
      optionsEn: ["I am the bed", "I make the bed", "I made the bed", "I am going to make the bed"],
    ...
    },
    {
      ...
      optionsEn: ["I'm going to clean the house tomorrow.", "I will clean tomorrow.", "Tomorrow cleans.", "I must clean tomorrow."],
