...
<tbody>
<tr><td class=\"\">la mairie<\/td><td>town hall<\/td><\/tr>
<tr><td class=\"\">la préfecture<\/td><td>prefecture (admin centre)<\/td><\/tr>
<tr><td class=\"\">la Sécurité Sociale<\/td><td>French health insurance<\/td><\/tr>
<tr><td class=\"\">la carte Vitale<\/td><td>health insurance card<\/td><\/tr>
<tr><td class=\"\">le médecin traitant<\/td><td>GP / family doctor<\/td><\/tr>
</tbody>
<\/table>
<\/div>
<div class="lesson-rule">
...
<tbody>
<tr><td class=\"\">la box internet<\/td><td>internet router/package<\/td><\/tr>
<tr><td class=\"\">EDF (électricité)<\/td><td>electricity provider<\/td><\/tr>
<tr><td class=\"\">la déchetterie<\/td><td>recycling/waste centre<\/td><\/tr>
</table><td class=\"\">le contrôle technique<\/td><td>MOT / vehicle inspection<\/td><\/tr>
</tbody>
<\/table>
<\/div>
<div class="lesson-example">
<strong>Exemple :<\/strong> Je dois aller à la mairie pour ma carte de séjour.
  ...
  qcm: [
    {
      ...
      questionFr: "Où allez-vous pour changer officiellement d'adresse ?",
    ...
    },
    {
      ...
      questionFr: "Traduisez : 'Je dois prendre rendez-vous avec mon médecin.'",
    ...
    },
    {
      ...
      questionFr: "Qu'est-ce que 'la déchetterie' ?",
    ...
    },
    {
      ...
      questionFr: "Traduisez : 'Internet ne marche pas.'",
      options: ["Internet ne marche pas.", "La box est cassée.", "Je n'ai pas internet.", "Internet est mort."],
      optionsEn: ["The internet is not working.", "The router is broken.", "I don't have internet.", "Internet is dead."],
    ...
    },
    {
      ...
      questionFr: "Comment dit-on 'la facture d'électricité' ?",
      options: ["La facture d'électricité", "Le billet électrique", "La note de courant", "Le papier EDF"],
      optionsEn: ["The electricity bill", "The electric ticket", "The current bill", "The EDF paper"],
    ...
    },
    {
      ...
      questionFr: "Traduisez : 'Je dois m'inscrire à la mairie.'",
      options: ["Je dois m'inscrire à la mairie.", "Je vais mairie.", "Je dois mairie.", "Je m'inscris mairie."],
      optionsEn: ["I need to register at the town hall.", "I go town hall.", "I must town hall.", "I register town hall."],
    ...
    },
    {
      ...
      questionFr: "Traduisez : 'La collecte des ordures est le jeudi.'",
      options: ["La collecte des ordures est le jeudi.", "Les poubelles jeudi.", "Ramassage poubelle jeudi.", "Collecte jeudi ordures."],
      optionsEn: ["The rubbish collection is on Thursday.", "The bins Thursday.", "Bin collection Thursday.", "Collection Thursday rubbish."],
    ...
    },
    {
      ...
      questionFr: "Comment dit-on 'Ma voiture a besoin d'une révision' ?",
      options: ["Ma voiture a besoin d'une révision.", "Mon voiture réparation.", "Ma voiture est cassée.", "Je dois garage."],
      optionsEn: ["My car needs a service.", "My car repair.", "My car is broken.", "I must garage."],
    ...
    },
    {
      ...
      questionFr: "Traduisez : 'Je dois renouveler ma carte de séjour.'",
  ...
  libre: [
    {
      ...
      questionFr: "Traduisez : 'Je dois aller à la mairie.'",
    ...
    },
    {
      ...
      questionFr: "À quoi sert 'la carte Vitale' ?",
    ...
    },
    {
      ...
      questionFr: "Complétez : 'Je dois prendre ___ avec mon médecin.'",
      correct: "rendez-vous",
      correctEn: "appointment",
      alternatives: [],
    ...
    },
    {
      ...
      questionFr: "Traduisez : 'La facture d'électricité est arrivée aujourd'hui.'",
    ...
    },
    {
      ...
      questionFr: "Traduisez : 'Il y a une déchetterie près d'ici ?'",
    ...
    },
    {
      ...
      questionFr: "Que signifie 'ça ne marche pas' ?",
    ...
    },
    {
      ...
      questionFr: "Complétez : 'Je dois m'___ à la mairie.'",
      correct: "inscrire",
      correctEn: "register",
      alternatives: [],
    ...
    },
    {
      ...
      questionFr: "Traduisez : 'Ma carte de séjour expire le mois prochain.'",
