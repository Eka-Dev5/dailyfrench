...
const LESSON_02 = {
  ...
  hintFr: "Ajoutez toujours 's'il vous plaît' — les marchands français apprécient la politesse !",
  vocabulary: [],
  contentHtml: `
...
<span class="lesson-ex-en">Here you go! Is that everything?</span>
  ...
  qcm: [
    ...
    },
    {
      ...
      explanationFr: "C'est combien ? = C'est combien ? Très courant au marché."
    },
    {
      id: "02-3",
      type: "qcm",
    ...
    },
    {
      ...
      explanationFr: "Avez-vous ? = Avez-vous ? Forme de question formelle très polie."
    },
    {
      id: "02-5",
      type: "qcm",
      question: "'Half a kilo' in French:",
      questionFr: "'Half a kilo' en français :",
    ...
    },
    {
      ...
      questionFr: "'Je le prends.' au marché :",
      ...
      explanationFr: "Je le prends = Je le prends. C'est la façon naturelle de dire que vous allez acheter quelque chose."
    },
    {
      id: "02-9",
      type: "qcm",
      question: "The polite word for 'please' (formal) in French:",
      questionFr: "Le mot poli pour 'please' (formel) en français :",
    ...
    },
    {
      ...
      questionFr: "'Three hundred grams of cheese' en français :",
      ...
      explanationFr: "Trois cents grammes = 300g. Aux marchés français, spécifiez toujours le poids clairement."
    }
  ],
  libre: [
    {
      ...
      explanationFr: "Des pommes = des pommes. Utilisez 'des' pour le pluriel indénombrable."
    },
    {
      id: "02-l2",
      type: "libre",
    ...
    },
    {
      ...
      explanationFr: "Pommes de terre = pommes de terre (littéralement 'pommes de la terre')."
    },
    {
      id: "02-l4",
      type: "libre",
