// ═══════════════════════════════════════════════════════════════════
// CONVERSATION.JS — Daily French 🥖 v2.0
// UNIFORME : même pattern que quiz.js (attend conversationsLoaded)
// Format données : dialogue: [{speaker, text, choices: [{text, correct, feedback}]}]
// ═══════════════════════════════════════════════════════════════════
...
// ── INIT PRINCIPAL (pattern quiz.js / vocabulary.js) ─────────────
