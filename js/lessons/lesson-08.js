...
const LESSON_08 = {
  ...
  objectiveFr: "Parler de la meteo, comprendre les previsions",
  hintEn: "Il fait + adjective for general weather. Il pleut/neige use verbs directly.",
  hintFr: "Il fait + adjectif pour la meteo generale. Il pleut/neige utilise les verbes directement.",
  vocabulary: [],
  contentHtml: `
<div class="lesson-rule">
<h4>Weather expressions</h4>
...
<div class="lesson-rule">
<h4>Temperature & seasons</h4>
<table class="lesson-table">
<tr><th>French</th><th>English</th></tr>
<tr><td>Il fait 25 degres.</td><td>It s 25 degrees.</td></tr>
<tr><td>le printemps / l ete / l automne / l hiver</td><td>spring / summer / autumn / winter</td></tr>
</table>
</div>
  ...
  qcm: [
    {
      ...
      explanationFr: "Il pleut = il pleut. Verbe irregulier pleuvoir. Tres utile en France !"
    },
    {
      id: "08-2",
      type: "qcm",
      ...
      explanationFr: "Il fait beau = il fait beau. Il fait + adjectif pour la meteo."
    },
    {
      id: "08-3",
      type: "qcm",
    ...
    },
    {
      ...
      options: ["Il y a du brouillard.","Il fait sombre.","Il y a brouillard.","Le brouillard est la."],
    ...
    },
    {
      ...
      questionFr: "Il fait 28 degres. en anglais :",
      options: ["Il fait 28 degres.","C est 28 degres.","Il y a 28 degres.","28 degres il fait."],
      optionsEn: ["It s 28 degrees.","It s 28 degrees.","There are 28 degrees.","28 degrees it makes."],
      correct: "Il fait 28 degres.",
      correctEn: "It s 28 degrees.",
      explanation: "Il fait X degres = It s X degrees. The most natural French weather temperature phrase.",
      explanationFr: "Il fait X degres = il fait X degres. La phrase la plus naturelle en francais."
    },
    {
      id: "08-9",
      type: "qcm",
      ...
      options: ["Il va pleuvoir demain.","Il pleuvra demain.","Demain il pleut.","Il va pleuvoir apres."],
      ...
      explanationFr: "Il va + infinitif = il va. Pleuvoir = pleuvoir. Futur proche pour les previsions !"
    },
    {
      id: "08-10",
      type: "qcm",
      ...
      correctEn: "Spring",
      explanation: "Le printemps (pran-TON) = spring. L ete = summer. L automne = autumn. L hiver = winter.",
      explanationFr: "Le printemps = le printemps. L ete = l ete. L automne = l automne. L hiver = l hiver."
    }
  ],
  libre: [
    {
    ...
    },
    {
      ...
      explanationFr: "Il pleut du verbe irregulier pleuvoir. Tres courant en France !"
    },
    {
      id: "08-l3",
      type: "libre",
      question: "Complete: Il fait ___ aujourd hui, vous ne trouvez pas ?",
      questionFr: "Completez : Il fait ___ aujourd hui, vous ne trouvez pas ?",
      correct: "beau",
      correctEn: "nice",
    ...
    },
    {
      ...
      questionFr: "Comment dit-on Il fait tres chaud ?",
      correct: "Il fait tres chaud.",
      correctEn: "It s very hot.",
      alternatives: [],
      explanation: "Tres = very. Il fait chaud = it s hot.",
      explanationFr: "Tres = tres. Il fait chaud = il fait chaud."
    },
    {
      id: "08-l6",
      type: "libre",
    ...
    },
    {
      ...
      questionFr: "Completez : Il y a du ___ aujourd hui.",
      correct: "vent",
      correctEn: "wind",
      alternatives: [],
