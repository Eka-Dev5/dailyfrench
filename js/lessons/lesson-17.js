...
<tbody>
<tr><td class=\"\">Je vais cuisiner.<\/td><td>I'm going to cook.<\/td><\/tr>
<tr><td class=\"\">Elle va téléphoner.<\/td><td>She's going to phone.<\/td><\/tr>
<tr><td class=\"\">Nous allons au marché.<\/td><td>We're going to the market.<\/td><\/tr>
<tr><td class=\"\">Je vais faire les courses.<\/td><td>I'm going to do the shopping.<\/td><\/tr>
</tbody>
<\/table>
<\/div>
<div class="lesson-rule">
...
<tr><td class=\"\">ce week-end<\/td><td>this weekend<\/td><\/tr>
<tr><td class=\"\">la semaine prochaine<\/td><td>next week<\/td><\/tr>
<tr><td class=\"\">le mois prochain<\/td><td>next month<\/td><\/tr>
</tr><td class=\"\">bientôt<\/td><td>soon<\/td><\/tr>
</tbody>
<\/table>
<\/div>
<div class="lesson-example">
Ce week-end je vais nettoyer la maison et nous allons au restaurant dimanche.
  ...
  qcm: [
    {
      ...
      questionFr: "Traduisez : 'Je vais cuisiner.'",
      options: ["Je vais cuisiner.", "Je suis cuisiner.", "J'ai cuisiné.", "Je cuisine."],
      optionsEn: ["I am going to cook.", "I am cook (wrong)", "I cooked", "I cook"],
    ...
    },
    {
      ...
      questionFr: "Traduisez : 'Elle va téléphoner.'",
      options: ["Elle va téléphoner.", "Elle est téléphoner.", "Elle va téléphone.", "Elle ira téléphoner."],
      optionsEn: ["She is going to phone.", "She is phone (wrong)", "She goes phone (noun)", "She will phone"],
    ...
    },
    {
      ...
      questionFr: "Comment dit-on 'la semaine prochaine' ?",
      options: ["La semaine prochaine", "La prochaine semaine", "Semaine prochaine", "Next week"],
      optionsEn: ["Next week", "Next week (adj before noun)", "Week next", "Next week (English)"],
    ...
    },
    {
      ...
      optionsEn: ["This weekend", "This end of week", "This weekend (alt spelling)", "This we (slang)"],
      correct: "Ce week-end",
    ...
    },
    {
      ...
      questionFr: "Traduisez : 'Nous allons au restaurant.'",
      options: ["Nous allons au restaurant.", "Nous allons à restaurant.", "Nous allons le restaurant.", "Nous sommes restaurant."],
      optionsEn: ["We are going to the restaurant.", "We go to restaurant (missing article)", "We go the restaurant", "We are restaurant"],
      correct: "Nous allons au restaurant.",
      correctEn: "We are going to the restaurant.",
    ...
    },
    {
      ...
      optionsEn: ["I am going to eat", "I ate", "I eat", "I will eat"],
      correct: "Je vais manger",
      correctEn: "I am going to eat",
    ...
    },
    {
      ...
      optionsEn: ["I am going to do the shopping.", "I go the shopping do (wrong order)", "I do the shopping (present)", "I go the shopping"],
    ...
    },
    {
      ...
      optionsEn: ["Soon", "Quickly", "Next", "After"],
      correct: "Bientôt",
      correctEn: "Soon",
    ...
    },
    {
      ...
      optionsEn: ["Next month", "Next month (adj before noun)", "Month next", "Next month (duplicate)"],
    ...
    },
    {
      ...
      questionFr: "Traduisez : 'Ils vont nous rendre visite.'",
      options: ["Ils vont nous rendre visite.", "Ils sont nous visiter.", "Ils vont nous visit.", "Ils allons visiter."],
      optionsEn: ["They are going to visit us.", "They are us visit (wrong)", "They go us visit (English)", "They we go visit (wrong)"],
      correct: "Ils vont nous rendre visite.",
      correctEn: "They are going to visit us.",
