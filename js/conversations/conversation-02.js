// conversation-02.js — Niveau 2 : Au marché
const CONVERSATION_02 = {
  id: "marche",
  icon: "🛒",
  title: "At the Market",
  titleFr: "Au marché",
  ...
  dialogue: [
    ...
    { speaker: "you", text: "___", choices: [
      ...
      { text: "Tomates et pommes.", correct: false, feedback: "Too brief! Use full sentences." }
    ]},
    { speaker: "vendor", text: "Voilà. Ça fait 4,50 €." },
    { speaker: "you", text: "___", choices: [
      { text: "C est combien les pommes seules ? Et je voudrais aussi un bouquet de basilic.", correct: true, feedback: "Excellent! You asked for details + added another item. Very natural!" },
      { text: "Voici 5 €.", correct: false, feedback: "OK but abrupt! Ask about prices or add something." },
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = CONVERSATION_02;
} else {
  window.CONVERSATION_02 = CONVERSATION_02;
}
